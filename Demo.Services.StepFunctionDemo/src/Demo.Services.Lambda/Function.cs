...
namespace Demo.Services.Lambda
{
    ...
    {
        public const string OddEvenStateMachineArnKey = "STATE_MACHINE_ARN";
        ...
        public Functions() : this(
            ...
            new AmazonS3Client(),
            System.Environment.GetEnvironmentVariable(OddEvenStateMachineArnKey), 
        ...
        public async Task Process12Function(JobInfo jobInfo, ILambdaContext context)
        {
            System.Threading.Thread.Sleep(3000);
